...
import ujwal.android.com.meow.cards.SliderAdapter;
import ujwal.android.com.meow.utils.DecodeBitmapTask;
...
public class BreedsActivity extends AppCompatActivity {
    ...
    private void initSwitchers() {
        ...
        temperatureSwitcher.setCurrentText(lifespan[0]);

        placeSwitcher = (TextSwitcher) findViewById(R.id.ts_place);
        placeSwitcher.setFactory(new TextViewFactory(R.style.PlaceTextView, false));
        placeSwitcher.setCurrentText(names[0]);

        clockSwitcher = (TextSwitcher) findViewById(R.id.ts_clock);
        clockSwitcher.setFactory(new TextViewFactory(R.style.ClockTextView, false));
        clockSwitcher.setCurrentText(origin[0]);
    ...
    private void initCountryText() {
        ...
        country1TextView.setText(breeds[0]);
    ...
    private void onActiveCardChange(int pos) {
        ...
        setCountryText(breeds[pos % breeds.length], left2right);

        temperatureSwitcher.setInAnimation(BreedsActivity.this, animH[0]);
        temperatureSwitcher.setOutAnimation(BreedsActivity.this, animH[1]);
        temperatureSwitcher.setText(lifespan[pos % lifespan.length]);

        placeSwitcher.setInAnimation(BreedsActivity.this, animV[0]);
        placeSwitcher.setOutAnimation(BreedsActivity.this, animV[1]);
        placeSwitcher.setText(names[pos % names.length]);

        clockSwitcher.setInAnimation(BreedsActivity.this, animV[0]);
        clockSwitcher.setOutAnimation(BreedsActivity.this, animV[1]);
        clockSwitcher.setText(origin[pos % origin.length]);
    ...
    private class TextViewFactory implements  ViewSwitcher.ViewFactory {
        ...
        public View makeView() {
            final TextView textView = new TextView(BreedsActivity.this);
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
                textView.setTextAppearance(BreedsActivity.this, styleId);
            } else {
    ...
    private class ImageViewFactory implements ViewSwitcher.ViewFactory {
        @Override
        public View makeView() {
            final ImageView imageView = new ImageView(BreedsActivity.this);
    ...
    private class OnCardClickListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (clickedPosition == activeCardPosition) {
                final Intent intent = new Intent(BreedsActivity.this, DetailsActivity.class);
                ...
                if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
                    ...
                    final ActivityOptions options = ActivityOptions
                            .makeSceneTransitionAnimation(BreedsActivity.this, sharedView, "shared");
